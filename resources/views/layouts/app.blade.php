                ...
                @if (auth()->user()->canManage())
                    <div class="nav-section">
                        ...
                        <ul class="space-y-0.5">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('daily-reports.monitoring') }}"
                                    class="nav-link {{ request()->routeIs('daily-reports.monitoring') ? 'active' : '' }}">
                                    <i class="fas fa-clipboard-list"></i>
                                    <span>Daily Report</span>
                                </a>
                            </li>
        ...
        <main class="main-content">
            ...
            <header class="header">
                ...
                <div class="header-actions flex items-center gap-1.5 sm:gap-3 flex-shrink-0">
                    ...
                    @endphp
                    <div class="dropdown">
                        <button class="btn btn-icon btn-secondary relative w-8 h-8 sm:w-9 sm:h-9"
                    ...
                    <div class="user-menu px-1.5 py-1 sm:px-3 sm:py-1.5">
                        @if (auth()->user()->avatar)
                            <img src="{{ Str::startsWith(auth()->user()->avatar, ['http', 'https']) ? auth()->user()->avatar : asset('storage/avatars/' . auth()->user()->avatar) }}"
                                ...
                                class="user-avatar w-7 h-7 sm:w-8 sm:h-8 rounded-full object-cover">
                        @else
